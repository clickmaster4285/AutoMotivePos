...
export const seedUsers: User[] = [
  { id: 'user-1', name: 'Alex Morgan', username: 'admin', password: 'admin123', email: 'alex@autopos.com', role: 'admin', branchId: 'branch-1' },
  { id: 'user-2', name: 'Sam Rivera', username: 'sam', password: 'sam123', email: 'sam@autopos.com', role: 'branch_manager', branchId: 'branch-1' },
  { id: 'user-3', name: 'Jordan Lee', username: 'jordan', password: 'jordan123', email: 'jordan@autopos.com', role: 'service_advisor', branchId: 'branch-1' },
  { id: 'user-4', name: 'Casey Park', username: 'casey', password: 'casey123', email: 'casey@autopos.com', role: 'technician', branchId: 'branch-1' },
  { id: 'user-5', name: 'Taylor Kim', username: 'taylor', password: 'taylor123', email: 'taylor@autopos.com', role: 'cashier', branchId: 'branch-1' },
  { id: 'user-6', name: 'Morgan Chen', username: 'morgan', password: 'morgan123', email: 'morgan@autopos.com', role: 'branch_manager', branchId: 'branch-2' },
  { id: 'user-7', name: 'Riley Adams', username: 'riley', password: 'riley123', email: 'riley@autopos.com', role: 'inventory_manager', branchId: 'branch-1' },
];
