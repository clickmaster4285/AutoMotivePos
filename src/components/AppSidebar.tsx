...
import {
  ...
  RotateCcw, ArrowRightLeft, ScrollText
} from 'lucide-react';
import {
...
const allNavItems = [
  { title: 'Dashboard', url: '/', icon: LayoutDashboard, roles: ['admin', 'branch_manager', 'service_advisor', 'technician', 'cashier', 'inventory_manager'] },
  { title: 'Inventory', url: '/inventory', icon: Package, roles: ['admin', 'branch_manager', 'service_advisor', 'inventory_manager'] },
  { title: 'Transfers', url: '/transfers', icon: ArrowRightLeft, roles: ['admin', 'branch_manager', 'inventory_manager'] },
  { title: 'Job Cards', url: '/jobs', icon: Wrench, roles: ['admin', 'branch_manager', 'service_advisor', 'technician'] },
  { title: 'Point of Sale', url: '/pos', icon: ShoppingCart, roles: ['admin', 'branch_manager', 'cashier'] },
  { title: 'Refunds', url: '/refunds', icon: RotateCcw, roles: ['admin', 'branch_manager', 'cashier'] },
  { title: 'Customers', url: '/customers', icon: Users, roles: ['admin', 'branch_manager', 'service_advisor'] },
  { title: 'Suppliers', url: '/suppliers', icon: Truck, roles: ['admin', 'branch_manager'] },
  { title: 'Reports', url: '/reports', icon: BarChart3, roles: ['admin', 'branch_manager'] },
